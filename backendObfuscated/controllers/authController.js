...
const createSendToken = (_0x706aaa, _0xce8821, _0x1e65d9) => {
  const _0x569869 = jwt.sign({
    'id': _0x706aaa._id
  ...
  _0x1e65d9.status(_0xce8821).json({
    'status': "success",
    'token': _0x569869,
    'user': _0x706aaa
  });
};
const filterObj = (_0x26e15d, ..._0x38b553) => {
  let _0x5e6320 = {};
  Object.keys(_0x26e15d).forEach(_0x4ec893 => {
    if (_0x38b553.includes(_0x4ec893)) {
...
exports.signup = async (_0x4678b6, _0x3795ae) => {
  try {
    const _0x3da929 = await User.create({
      'name': _0x4678b6.body.name,
      'email': _0x4678b6.body.email,
      'phoneNumber': _0x4678b6.body.phoneNumber,
      'password': _0x4678b6.body.password,
      'passwordConfirm': _0x4678b6.body.passwordConfirm,
      'avatar': {
        'url': _0x4678b6.body.avatar || "https://t3.ftcdn.net/jpg/01/18/01/98/360_F_118019822_6CKXP6rXmVhDOzbXZlLqEM2ya4HhYzSV.jpg"
      }
    });
    createSendToken(_0x3da929, 0xc9, _0x3795ae);
  } catch (_0x4afab9) {
    _0x3795ae.status(0x190).json({
      'message': _0x4afab9.message
    });
  }
};
exports.login = async (_0x25214e, _0x1dc635) => {
  try {
    ...
    if (!_0x10f087 || !_0x18a115) {
      throw new Error("Please provide email and password");
    }
    const _0x5e254b = await User.findOne({
      'email': _0x10f087
    }).select("+password");
    if (!_0x5e254b || !(await _0x5e254b.correctPassword(_0x18a115, _0x5e254b.password))) {
      throw new Error("Incorect email or password");
    }
    createSendToken(_0x5e254b, 0xc8, _0x1dc635);
  } catch (_0xa5044) {
    _0x1dc635.status(0x190).json({
      'message': "Login in unsuccessfull"
    });
  }
};
exports.logout = (_0x61f494, _0x4afd4f) => {
  _0x4afd4f.cookie("jwt", "loggedout", {
    'expires': new Date(Date.now() + 1000),
    'httpOnly': true
  });
  _0x4afd4f.status(0xc8).json({
    'status': 'success'
  });
};
exports.protect = async (_0x247439, _0x2b6049, _0x36a126) => {
  try {
    let _0x5615e9;
    if (_0x247439.headers.authorization && _0x247439.headers.authorization.startsWith("Bearer")) {
      _0x5615e9 = _0x247439.headers.authorization.split(" ")[0x1];
    } else if (_0x247439.cookies.jwt && _0x247439.cookies.jwt !== "loggedout") {
      _0x5615e9 = _0x247439.cookies.jwt;
    }
    if (!_0x5615e9) {
      throw new Error("You are not Logged!! Please log in to get access");
    }
    const _0x3ce0fd = await promisify(jwt.verify)(_0x5615e9, process.env.JWT_SECRET);
    const _0x45f9da = await User.findById(_0x3ce0fd.id);
    if (!_0x45f9da) {
      throw new Error("the user belonging to the token doesn't exsists");
    }
    if (_0x45f9da.changedPasswordAfter(_0x3ce0fd.iat)) {
      throw new Error("User recently cahnged the password, Please login again");
    }
    _0x247439.user = _0x45f9da;
    _0x36a126();
  } catch (_0x38fb82) {
    _0x2b6049.status(0x191).json({
      'status': "fail",
      'message': _0x38fb82.message
    });
  }
};
exports.updateMe = async (_0x200175, _0x361d99, _0x571b68) => {
  try {
    const _0x24378e = filterObj(_0x200175.body, "name", "phoneNumber", "avatar");
    console.log(_0x24378e);
    console.log(_0x200175.body.avatar);
    if (_0x200175.body.avatar !== undefined) {
      const _0x325a9a = await cloudinary.uploader.upload(_0x200175.body.avatar, {
        'folder': "avatars",
        'width': 0x96,
        'height': 0x96,
        'crop': 'scale',
      ...
      _0x24378e.avatar = {
        'public_id': _0x325a9a.public_id,
        'url': _0x325a9a.secure_url
      };
    }
    const _0x4507d1 = await User.findByIdAndUpdate(_0x200175.user.id, _0x24378e, {
      'new': true,
      'runValidators': true,
      'useFindAndModify': false
    });
    _0x361d99.status(0xc8).json({
      'status': "Succes",
      'data': {
        'user': _0x4507d1
      }
    ...
    _0x361d99.status(0x191).json({
      'status': "Fail",
      'message': _0x2108bb.message
    });
  }
};
exports.updatePassword = async (_0x3e6751, _0x16c067, _0x1d4eb7) => {
  try {
    const _0x1f5eff = await User.findById(_0x3e6751.user.id).select("+password");
    if (!(await _0x1f5eff.correctPassword(_0x3e6751.body.passwordCurrent, _0x1f5eff.password))) {
      throw new Error("Your current password is wrong");
    }
    _0x1f5eff.password = _0x3e6751.body.password;
    _0x1f5eff.passwordConfirm = _0x3e6751.body.passwordConfirm;
    await _0x1f5eff.save();
    createSendToken(_0x1f5eff, 0xc8, _0x16c067);
  } catch (_0x3336d2) {
    _0x16c067.status(0x194).json({
      'status': "fail",
      'message': _0x3336d2.message
    });
  }
};
exports.forgotPassword = async (_0x48f910, _0x23883e, _0x2323ab) => {
  const _0x49cd9a = await User.findOne({
    'email': _0x48f910.body.email
  });
  if (!_0x49cd9a) {
    _0x23883e.status(0x190).json({
      'error': "There is no user with this email"
    });
  }
  const _0x3e05cd = _0x49cd9a.createPasswordResetToken();
  await _0x49cd9a.save({
    'validateBeforeSave': false
  });
  const _0x17491a = "http://localhost:3000/user/resetPassword/" + _0x3e05cd;
  const _0x840a1 = "<p>Forgot your password? Submit a PATCH request with your new password and passwordConfirm. Click the button to resetpassword page.: <a href=\"" + _0x17491a + "\" style=\" display: inline-block; margin:10px; padding:10px; background-color: rgb(65, 60, 60, 0.5); border-radius:5px; text-decoration:none; color:white; font-size:20px\">Reset Password.</a><p>";
  try {
    await sendEmail({
      'email': _0x49cd9a.email,
      'subject': "Your password reset token valid for 10 mins",
      'message': _0x840a1
    });
    _0x23883e.status(0xc8).json({
      'status': "success",
...
exports.resetPassword = async (_0x1ffb1a, _0x3d16ff, _0x341384) => {
  try {
    const _0x55aa72 = crypto.createHash("sha256").update(_0x1ffb1a.params.token).digest("hex");
    const _0x588c30 = await User.findOne({
    ...
    _0x588c30.password = _0x1ffb1a.body.password;
    _0x588c30.passwordConfirm = _0x1ffb1a.body.passwordConfirm;
    _0x588c30.passwordResetToken = undefined;
    _0x588c30.passwordResetExpires = undefined;
    await _0x588c30.save();
    createSendToken(_0x588c30, 0xc8, _0x3d16ff);
  } catch (_0x4e07d4) {
    _0x3d16ff.status(0x190).json({
      'status': "fail",
      'error': _0x4e07d4.message
    });
    return _0x341384();
  }
};
exports.isLoggedIn = async (_0x402c3e, _0x19f78e, _0x3b0dce) => {
  try {
    if (_0x402c3e.cookies.jwt) {
      const _0x498c5c = await promisify(jwt.verify)(_0x402c3e.cookies.jwt, process.env.JWT_SECRET);
      const _0x4d5581 = await User.findById(_0x498c5c.id);
      if (!_0x4d5581) {
        return _0x3b0dce();
      }
      if (_0x4d5581.changedPasswordAfter(_0x498c5c.iat)) {
        return _0x3b0dce();
      }
      _0x19f78e.status(0xc8).json({
        'status': "success",
        'user': _0x4d5581
      });
      return _0x3b0dce();
